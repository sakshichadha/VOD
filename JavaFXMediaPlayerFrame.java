...
public class JavaFXMediaPlayerFrame extends javax.swing.JFrame {
    ...
    public JavaFXMediaPlayerFrame(String vpath) {
        initComponents();
    ...
    private void initFX(JFXPanel fxPanel) {
        ...
        final Media m = new Media("http://"+GlobalData.host+"/StreamMedia/"+path);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JavaFXMediaPlayerFrame("src/VideoContents/abc.mp4").setVisible(true);
            }
        });
    }
